...
describe(Support.getTestDialectTeaser('SQL'), () => {
  describe('generateJoin', () => {
    ...
    testsql(
      ...
      {
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`company` AS `Company` ON `sequelize_test`.`User`.`company_id` = `Company`.`id`',
    ...
    testsql(
      ...
      },
      {
        ...
        mysql: 'INNER JOIN `sequelize_test`.`company` AS `Company` ON `sequelize_test`.`User`.`company_id` = `Company`.`id` OR `Company`.`public` = true',
    ...
    testsql(
      ...
      {
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`company` AS `Professionals->Company` ON `sequelize_test`.`Professionals`.`company_id` = `Professionals->Company`.`id`',
    ...
    testsql(
      ...
      },
      {
        ...
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`company` AS `Company` ON `sequelize_test`.`User`.`companyId` = `Company`.`id`'
      }
    );
    ...
    testsql(
      ...
      },
      {
        ...
        mysql: "LEFT OUTER JOIN `sequelize_test`.`company` AS `Company` ON `sequelize_test`.`User`.`companyId` = `Company`.`id` AND `Company`.`name` = 'ABC'",
    ...
    testsql(
      ...
      },
      {
        ...
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`user` AS `Company->Owner` ON `sequelize_test`.`Company`.`owner_id` = `Company->Owner`.`id_user`'
      }
    );
    ...
    testsql(
      ...
      { 
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`profession` AS `Company->Owner->Profession` ON `sequelize_test`.`Company->Owner`.`professionId` = `Company->Owner->Profession`.`id`',
    ...
    testsql(
      ...
      },
      {
        ...
        mysql: 'INNER JOIN `sequelize_test`.`company` AS `Company` ON `sequelize_test`.`User`.`companyId` = `Company`.`id`'
      }
    );
    ...
    testsql(
      ...
      { 
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`task` AS `Tasks` ON `sequelize_test`.`User`.`id_user` = `Tasks`.`user_id`',
    ...
    testsql(
      ...
      },
      {
        ...
        mysql: 'LEFT OUTER JOIN `sequelize_test`.`task` AS `Tasks` ON `sequelize_test`.`User`.`id` = `Tasks`.`user_id`',
